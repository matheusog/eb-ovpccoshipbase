sap.ui.define([
	...
	var sDialogName = "com.eldorado.sap.eblog.ovpccoshipbase.view.fragments.commons.MessageDialog";
		...
		function getConfiguredPopoverIfNeeded(bSuccess){
            ...
            return new Promise(function (fnResolve) {
				getDialogFragmentForViewAsync( oController.getView(),
				  "com.eldorado.sap.eblog.ovpccoshipbase.view.fragments.commons.MessageDialog", {
	...
	return BaseObject.extend("com.eldorado.sap.eblog.ovpccoshipbase.model.MessageHandler", {
